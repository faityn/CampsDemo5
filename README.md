...
- `public/images/` — одоогийн demo зургууд

> `public/images/reference.png` нь дизайны эх загварын reference зураг. Бусад зургууд нь тэр reference-ээс авсан demo crop-ууд бөгөөд бодит амралтын газрын зурагтай солиход бэлэн.
